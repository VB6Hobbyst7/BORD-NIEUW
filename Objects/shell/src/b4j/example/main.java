...
public static b4j.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"CSSUtils",main._cssutils,"DateUtils",main._dateutils,"func",Debug.moduleToString(b4j.example.func.class),"funcInet",Debug.moduleToString(b4j.example.funcinet.class),"fx",main._fx,"HttpUtils2Service",Debug.moduleToString(b4j.example.httputils2service.class),"MainForm",main._mainform,"parseConfig",Debug.moduleToString(b4j.example.parseconfig.class),"scorebord",Debug.moduleToString(b4j.example.scorebord.class)};
}
}