...
try {
		Debug.PushSubsStack("Base_Resize (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("getValue (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("Initialize (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("setValue (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("SetValueBasedOnTouch (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("TouchPanel_Touch (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,84);
...
{ BA.debugLineNum = 88;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_MOVE The";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 90;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_UP Then";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Update (b4xseekbar) ","b4xseekbar",26,__ref.getField(false, "ba"),__ref,57);
