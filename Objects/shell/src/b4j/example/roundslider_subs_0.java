...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,135);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("pnl_MouseClicked (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("pnl_MousePressed (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("pnl_MouseReleased (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",31,__ref.getField(false, "ba"),__ref,130);
