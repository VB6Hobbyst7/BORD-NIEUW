...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,250);
...
try {
		Debug.PushSubsStack("Background_MouseClicked (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,240);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,245);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,279);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,226);
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,231);
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,187);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,209);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,183);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,32);
...
{ BA.debugLineNum = 36;BA.debugLine="Else If xui.IsB4J Then";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 38;BA.debugLine="Else if xui.IsB4A Then";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,333);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,348);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,255);
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,319);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,217);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,69);
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,362);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",18,__ref.getField(false, "ba"),__ref,266);
