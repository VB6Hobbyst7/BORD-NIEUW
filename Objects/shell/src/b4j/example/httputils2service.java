...
public static b4j.example.parseconfig _parseconfig = null;
  public Object[] GetGlobals() {
		return new Object[] {"CSSUtils",httputils2service._cssutils,"DateUtils",httputils2service._dateutils,"func",Debug.moduleToString(b4j.example.func.class),"funcInet",Debug.moduleToString(b4j.example.funcinet.class),"hc",httputils2service._hc,"Main",Debug.moduleToString(b4j.example.main.class),"parseConfig",Debug.moduleToString(b4j.example.parseconfig.class),"scorebord",Debug.moduleToString(b4j.example.scorebord.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}