...
try {
		Debug.PushSubsStack("Base_Resize (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("CmbBox_SelectedIndexChanged (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("GetItem (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("getSelectedIndex (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,75);
...
try {
		Debug.PushSubsStack("Initialize (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("RaiseEvent (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("SetItems (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("setSelectedIndex (b4xcombobox) ","b4xcombobox",16,__ref.getField(false, "ba"),__ref,83);
