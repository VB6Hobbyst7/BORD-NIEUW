...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("p_MouseClicked (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,53);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",33,__ref.getField(false, "ba"),__ref,80);
