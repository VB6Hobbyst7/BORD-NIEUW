...
try {
		Debug.PushSubsStack("Base_Resize (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Draw (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("DrawItem (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("FindItem (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("getItems (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("Initialize (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("setItems (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("Touch_Touch (b4xbreadcrumb) ","b4xbreadcrumb",14,__ref.getField(false, "ba"),__ref,109);
