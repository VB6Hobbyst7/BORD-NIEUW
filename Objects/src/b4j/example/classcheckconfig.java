...
__c.CallSubNew(ba,(Object)(_scorebord.getObject()),"updateCfg");
 //BA.debugLineNum = 28;BA.debugLine="Log(\"USE DIGITAL \" & parseConfig.useDigitalFont)";
__c.Log("USE DIGITAL "+BA.ObjectToString(_parseconfig._usedigitalfont /*boolean*/ ));
...
__c.Log((""+__c.SmartStringFormatter("",(Object)(__c.DateTime.Date(_cfgtimestamp)))+""));
