...
RDebugUtils.currentLine=23658498;
 //BA.debugLineNum = 23658498;BA.debugLine="TouchPanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
...
RDebugUtils.currentLine=23658499;
 //BA.debugLineNum = 23658499;BA.debugLine="Vertical = mBase.Height > mBase.Width";
__ref._vertical /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()>__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth();
RDebugUtils.currentLine=23658500;
 //BA.debugLineNum = 23658500;BA.debugLine="size = Max(mBase.Height, mBase.Width) - 2 * Radiu";
...
RDebugUtils.currentLine=23658501;
 //BA.debugLineNum = 23658501;BA.debugLine="Update";
...
RDebugUtils.currentLine=23724034;
 //BA.debugLineNum = 23724034;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
RDebugUtils.currentLine=23724035;
 //BA.debugLineNum = 23724035;BA.debugLine="If size > 0 Then";
if (__ref._size /*int*/ >0) { 
RDebugUtils.currentLine=23724036;
 //BA.debugLineNum = 23724036;BA.debugLine="If Vertical = False Then";
if (__ref._vertical /*boolean*/ ==__c.False) { 
RDebugUtils.currentLine=23724037;
 //BA.debugLineNum = 23724037;BA.debugLine="Dim s1 As Int = Radius2 + (mValue - MinValue) /";
...
RDebugUtils.currentLine=23724038;
 //BA.debugLineNum = 23724038;BA.debugLine="Dim y As Int = mBase.Height / 2";
_y = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)2);
RDebugUtils.currentLine=23724039;
 //BA.debugLineNum = 23724039;BA.debugLine="cvs.DrawLine(Radius2, y, s1, y, Color1, Size1)";
...
RDebugUtils.currentLine=23724040;
 //BA.debugLineNum = 23724040;BA.debugLine="cvs.DrawLine(s1, y, mBase.Width - Radius2, y, C";
...
RDebugUtils.currentLine=23724041;
 //BA.debugLineNum = 23724041;BA.debugLine="cvs.DrawCircle(s1, y, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=23724042;
 //BA.debugLineNum = 23724042;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=23724043;
 //BA.debugLineNum = 23724043;BA.debugLine="cvs.DrawCircle(s1, y, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=23724046;
 //BA.debugLineNum = 23724046;BA.debugLine="Dim s1 As Int = Radius2 + (MaxValue - mValue -";
...
RDebugUtils.currentLine=23724047;
 //BA.debugLineNum = 23724047;BA.debugLine="Dim x As Int = mBase.Width / 2";
_x = (int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)2);
RDebugUtils.currentLine=23724048;
 //BA.debugLineNum = 23724048;BA.debugLine="cvs.DrawLine(x, Radius2, x, s1, Color2, Size2)";
...
RDebugUtils.currentLine=23724049;
 //BA.debugLineNum = 23724049;BA.debugLine="cvs.DrawLine(x, s1, x, mBase.Height - Radius2,";
...
RDebugUtils.currentLine=23724050;
 //BA.debugLineNum = 23724050;BA.debugLine="cvs.DrawCircle(x, s1, Radius1, Color1, True, 0)";
...
RDebugUtils.currentLine=23724051;
 //BA.debugLineNum = 23724051;BA.debugLine="If Pressed Then";
if (__ref._pressed /*boolean*/ ) { 
RDebugUtils.currentLine=23724052;
 //BA.debugLineNum = 23724052;BA.debugLine="cvs.DrawCircle(x, s1, Radius2, ThumbColor, Tru";
...
RDebugUtils.currentLine=23724056;
 //BA.debugLineNum = 23724056;BA.debugLine="cvs.Invalidate";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
RDebugUtils.currentLine=23724057;
 //BA.debugLineNum = 23724057;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=23461893;
 //BA.debugLineNum = 23461893;BA.debugLine="Public Color1, Color2, ThumbColor As Int";
_color1 = 0;
_color2 = 0;
_thumbcolor = 0;
RDebugUtils.currentLine=23461894;
 //BA.debugLineNum = 23461894;BA.debugLine="Private cvs As B4XCanvas";
_cvs = new anywheresoftware.b4a.objects.B4XCanvas();
RDebugUtils.currentLine=23461895;
 //BA.debugLineNum = 23461895;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=23461896;
 //BA.debugLineNum = 23461896;BA.debugLine="Private TouchPanel As B4XView";
_touchpanel = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=23461897;
 //BA.debugLineNum = 23461897;BA.debugLine="Private mValue As Int";
_mvalue = 0;
RDebugUtils.currentLine=23461898;
 //BA.debugLineNum = 23461898;BA.debugLine="Public MinValue, MaxValue As Int";
_minvalue = 0;
_maxvalue = 0;
RDebugUtils.currentLine=23461899;
 //BA.debugLineNum = 23461899;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=23461900;
 //BA.debugLineNum = 23461900;BA.debugLine="Public Size1 = 4dip, Size2 = 2dip, Radius1 = 6dip";
...
RDebugUtils.currentLine=23461901;
 //BA.debugLineNum = 23461901;BA.debugLine="Private Pressed As Boolean";
_pressed = false;
RDebugUtils.currentLine=23461902;
 //BA.debugLineNum = 23461902;BA.debugLine="Private size As Int";
_size = 0;
...
RDebugUtils.currentLine=23592963;
 //BA.debugLineNum = 23592963;BA.debugLine="Color1 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=23592964;
 //BA.debugLineNum = 23592964;BA.debugLine="Color2 = xui.PaintOrColorToColor(Props.Get(\"Color";
...
RDebugUtils.currentLine=23592965;
 //BA.debugLineNum = 23592965;BA.debugLine="ThumbColor = xui.PaintOrColorToColor(Props.Get(\"T";
...
RDebugUtils.currentLine=23592966;
 //BA.debugLineNum = 23592966;BA.debugLine="MinValue = Props.Get(\"Min\")";
__ref._minvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Min"))));
RDebugUtils.currentLine=23592967;
 //BA.debugLineNum = 23592967;BA.debugLine="MaxValue = Props.Get(\"Max\")";
__ref._maxvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Max"))));
RDebugUtils.currentLine=23592968;
 //BA.debugLineNum = 23592968;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, Props.Get(\"V";
...
RDebugUtils.currentLine=23592969;
 //BA.debugLineNum = 23592969;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(ba,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=23592970;
 //BA.debugLineNum = 23592970;BA.debugLine="TouchPanel = xui.CreatePanel(\"TouchPanel\")";
...
RDebugUtils.currentLine=23592971;
 //BA.debugLineNum = 23592971;BA.debugLine="mBase.AddView(TouchPanel, 0, 0, mBase.Width, mBas";
...
RDebugUtils.currentLine=23592972;
 //BA.debugLineNum = 23592972;BA.debugLine="If xui.IsB4A Or xui.IsB4i Then Radius2 = 20dip";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A() || __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4i()) { 
__ref._radius2 /*int*/  = __c.DipToCurrent((int) (20));};
RDebugUtils.currentLine=23592973;
 //BA.debugLineNum = 23592973;BA.debugLine="If xui.IsB4A Then Base_Resize(mBase.Width, mBase.";
...
RDebugUtils.currentLine=23920641;
 //BA.debugLineNum = 23920641;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, v))";
__ref._mvalue /*int*/  = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=23920642;
 //BA.debugLineNum = 23920642;BA.debugLine="Update";
__ref._update /*String*/ (null);
...
RDebugUtils.currentLine=23855104;
 //BA.debugLineNum = 23855104;BA.debugLine="Private Sub SetValueBasedOnTouch(x As Int, y As In";
RDebugUtils.currentLine=23855105;
 //BA.debugLineNum = 23855105;BA.debugLine="Dim v As Int";
_v = 0;
RDebugUtils.currentLine=23855106;
 //BA.debugLineNum = 23855106;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=23855107;
 //BA.debugLineNum = 23855107;BA.debugLine="v = (mBase.Height - Radius2 - y) / size * (MaxVa";
...
RDebugUtils.currentLine=23855109;
 //BA.debugLineNum = 23855109;BA.debugLine="v = (x - Radius2) / size * (MaxValue - MinValue)";
...
RDebugUtils.currentLine=23855111;
 //BA.debugLineNum = 23855111;BA.debugLine="Dim NewValue As Int = Max(MinValue, Min(MaxValue,";
_newvalue = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=23855112;
 //BA.debugLineNum = 23855112;BA.debugLine="If NewValue <> mValue Then";
if (_newvalue!=__ref._mvalue /*int*/ ) { 
RDebugUtils.currentLine=23855113;
 //BA.debugLineNum = 23855113;BA.debugLine="mValue = NewValue";
__ref._mvalue /*int*/  = _newvalue;
RDebugUtils.currentLine=23855114;
 //BA.debugLineNum = 23855114;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Value";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .SubExists(ba,__ref._mcallback /*Object*/ ,__ref._meventname /*String*/ +"_ValueChanged",(int) (1))) { 
RDebugUtils.currentLine=23855115;
 //BA.debugLineNum = 23855115;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Value";
...
RDebugUtils.currentLine=23789568;
 //BA.debugLineNum = 23789568;BA.debugLine="Private Sub TouchPanel_Touch (Action As Int, X As";
RDebugUtils.currentLine=23789569;
 //BA.debugLineNum = 23789569;BA.debugLine="If Action = TouchPanel.TOUCH_ACTION_DOWN Then";
if (_action==__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .TOUCH_ACTION_DOWN) { 
RDebugUtils.currentLine=23789570;
 //BA.debugLineNum = 23789570;BA.debugLine="Pressed = True";
__ref._pressed /*boolean*/  = __c.True;
RDebugUtils.currentLine=23789571;
 //BA.debugLineNum = 23789571;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=23789572;
 //BA.debugLineNum = 23789572;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_MOVE The";
...
RDebugUtils.currentLine=23789573;
 //BA.debugLineNum = 23789573;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=23789574;
 //BA.debugLineNum = 23789574;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_UP Then";
if (_action==__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .TOUCH_ACTION_UP) { 
RDebugUtils.currentLine=23789575;
 //BA.debugLineNum = 23789575;BA.debugLine="Pressed = False";
__ref._pressed /*boolean*/  = __c.False;
 }}}
;
RDebugUtils.currentLine=23789577;
 //BA.debugLineNum = 23789577;BA.debugLine="Update";
__ref._update /*String*/ (null);
