...
RDebugUtils.currentLine=25231371;
 //BA.debugLineNum = 25231371;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=25231372;
 //BA.debugLineNum = 25231372;BA.debugLine="Public Size1 = 4dip, Size2 = 2dip, Radius1 = 6dip";
...
RDebugUtils.currentLine=25231373;
 //BA.debugLineNum = 25231373;BA.debugLine="Private Pressed As Boolean";
_pressed = false;
RDebugUtils.currentLine=25231374;
 //BA.debugLineNum = 25231374;BA.debugLine="Private size As Int";
_size = 0;
RDebugUtils.currentLine=25231375;
 //BA.debugLineNum = 25231375;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=25362438;
 //BA.debugLineNum = 25362438;BA.debugLine="MinValue = Props.Get(\"Min\")";
__ref._minvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Min"))));
RDebugUtils.currentLine=25362439;
 //BA.debugLineNum = 25362439;BA.debugLine="MaxValue = Props.Get(\"Max\")";
__ref._maxvalue /*int*/  = (int)(BA.ObjectToNumber(_props.Get((Object)("Max"))));
RDebugUtils.currentLine=25362440;
 //BA.debugLineNum = 25362440;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, Props.Get(\"V";
...
RDebugUtils.currentLine=25362441;
 //BA.debugLineNum = 25362441;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(ba,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=25362442;
 //BA.debugLineNum = 25362442;BA.debugLine="TouchPanel = xui.CreatePanel(\"TouchPanel\")";
...
RDebugUtils.currentLine=25362443;
 //BA.debugLineNum = 25362443;BA.debugLine="mBase.AddView(TouchPanel, 0, 0, mBase.Width, mBas";
...
RDebugUtils.currentLine=25362444;
 //BA.debugLineNum = 25362444;BA.debugLine="If xui.IsB4A Or xui.IsB4i Then Radius2 = 20dip";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4A() || __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getIsB4i()) { 
__ref._radius2 /*int*/  = __c.DipToCurrent((int) (20));};
RDebugUtils.currentLine=25362445;
 //BA.debugLineNum = 25362445;BA.debugLine="If xui.IsB4A Then Base_Resize(mBase.Width, mBase.";
...
RDebugUtils.currentLine=25755648;
 //BA.debugLineNum = 25755648;BA.debugLine="Public Sub getValue As Int";
RDebugUtils.currentLine=25755649;
 //BA.debugLineNum = 25755649;BA.debugLine="Return mValue";
...
RDebugUtils.currentLine=25690112;
 //BA.debugLineNum = 25690112;BA.debugLine="Public Sub setValue(v As Int)";
RDebugUtils.currentLine=25690113;
 //BA.debugLineNum = 25690113;BA.debugLine="mValue = Max(MinValue, Min(MaxValue, v))";
__ref._mvalue /*int*/  = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=25690114;
 //BA.debugLineNum = 25690114;BA.debugLine="Update";
__ref._update /*String*/ (null);
...
RDebugUtils.currentLine=25624576;
 //BA.debugLineNum = 25624576;BA.debugLine="Private Sub SetValueBasedOnTouch(x As Int, y As In";
RDebugUtils.currentLine=25624577;
 //BA.debugLineNum = 25624577;BA.debugLine="Dim v As Int";
_v = 0;
RDebugUtils.currentLine=25624578;
 //BA.debugLineNum = 25624578;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=25624579;
 //BA.debugLineNum = 25624579;BA.debugLine="v = (mBase.Height - Radius2 - y) / size * (MaxVa";
...
RDebugUtils.currentLine=25624581;
 //BA.debugLineNum = 25624581;BA.debugLine="v = (x - Radius2) / size * (MaxValue - MinValue)";
...
RDebugUtils.currentLine=25624583;
 //BA.debugLineNum = 25624583;BA.debugLine="Dim NewValue As Int = Max(MinValue, Min(MaxValue,";
_newvalue = (int) (__c.Max(__ref._minvalue /*int*/ ,__c.Min(__ref._maxvalue /*int*/ ,_v)));
RDebugUtils.currentLine=25624584;
 //BA.debugLineNum = 25624584;BA.debugLine="If NewValue <> mValue Then";
if (_newvalue!=__ref._mvalue /*int*/ ) { 
RDebugUtils.currentLine=25624585;
 //BA.debugLineNum = 25624585;BA.debugLine="mValue = NewValue";
__ref._mvalue /*int*/  = _newvalue;
RDebugUtils.currentLine=25624586;
 //BA.debugLineNum = 25624586;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Value";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .SubExists(ba,__ref._mcallback /*Object*/ ,__ref._meventname /*String*/ +"_ValueChanged",(int) (1))) { 
RDebugUtils.currentLine=25624587;
 //BA.debugLineNum = 25624587;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Value";
...
RDebugUtils.currentLine=25559043;
 //BA.debugLineNum = 25559043;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=25559044;
 //BA.debugLineNum = 25559044;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_MOVE The";
...
RDebugUtils.currentLine=25559045;
 //BA.debugLineNum = 25559045;BA.debugLine="SetValueBasedOnTouch(X, Y)";
__ref._setvaluebasedontouch /*String*/ (null,(int) (_x),(int) (_y));
 }else 
{RDebugUtils.currentLine=25559046;
 //BA.debugLineNum = 25559046;BA.debugLine="Else If Action = TouchPanel.TOUCH_ACTION_UP Then";
if (_action==__ref._touchpanel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .TOUCH_ACTION_UP) { 
RDebugUtils.currentLine=25559047;
 //BA.debugLineNum = 25559047;BA.debugLine="Pressed = False";
__ref._pressed /*boolean*/  = __c.False;
 }}}
;
RDebugUtils.currentLine=25559049;
 //BA.debugLineNum = 25559049;BA.debugLine="Update";
__ref._update /*String*/ (null);
