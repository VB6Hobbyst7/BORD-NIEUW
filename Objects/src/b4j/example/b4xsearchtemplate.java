...
RDebugUtils.currentLine=23199747;
 //BA.debugLineNum = 23199747;BA.debugLine="Dim tf As B4JTextFlow";
_tf = new b4j.example.b4jtextflow();
RDebugUtils.currentLine=23199748;
 //BA.debugLineNum = 23199748;BA.debugLine="tf.Initialize";
...
RDebugUtils.currentLine=23199778;
 //BA.debugLineNum = 23199778;BA.debugLine="tf.Reset";
_tf._reset /*b4j.example.b4jtextflow*/ (null);
RDebugUtils.currentLine=23199779;
 //BA.debugLineNum = 23199779;BA.debugLine="If x > 0 Then";
if (_x>0) { 
RDebugUtils.currentLine=23199780;
 //BA.debugLineNum = 23199780;BA.debugLine="tf.Append(item.SubString2(0, x)).SetColor(Custo";
...
RDebugUtils.currentLine=23199782;
 //BA.debugLineNum = 23199782;BA.debugLine="If full.Length > 0 Then";
if (_full.length()>0) { 
RDebugUtils.currentLine=23199783;
 //BA.debugLineNum = 23199783;BA.debugLine="tf.Append(item.SubString2(x, x + full.Length)).";
...
RDebugUtils.currentLine=23199785;
 //BA.debugLineNum = 23199785;BA.debugLine="If x + full.Length < item.Length Then";
if (_x+_full.length()<_item.length()) { 
RDebugUtils.currentLine=23199786;
 //BA.debugLineNum = 23199786;BA.debugLine="tf.Append(item.SubString(x + full.Length)).SetC";
...
RDebugUtils.currentLine=23199788;
 //BA.debugLineNum = 23199788;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .CreatePanel(ba,"");
RDebugUtils.currentLine=23199789;
 //BA.debugLineNum = 23199789;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, CustomListView1.AsV";
...
RDebugUtils.currentLine=23199790;
 //BA.debugLineNum = 23199790;BA.debugLine="Dim TextPane As B4XView = tf.CreateTextFlow";
...
RDebugUtils.currentLine=23199791;
 //BA.debugLineNum = 23199791;BA.debugLine="p.AddView(TextPane, 0, p.Height / 2 - 12, p.Widt";
_p.AddView((javafx.scene.Node)(_textpane.getObject()),0,_p.getHeight()/(double)2-12,_p.getWidth(),_p.getHeight()/(double)2);
RDebugUtils.currentLine=23199792;
 //BA.debugLineNum = 23199792;BA.debugLine="p.Color = pnlColor";
_p.setColor(_pnlcolor);
RDebugUtils.currentLine=23199793;
 //BA.debugLineNum = 23199793;BA.debugLine="CustomListView1.Add(p, item)";
__ref._customlistview1 /*b4j.example.customlistview*/ ._add(_p,(Object)(_item));
 }
};
RDebugUtils.currentLine=23199796;
 //BA.debugLineNum = 23199796;BA.debugLine="For i = 0 To li.Size - 1";
{
final int step30 = 1;
final int limit30 = (int) (_li.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit30 ;_i = _i + step30 ) {
RDebugUtils.currentLine=23199797;
 //BA.debugLineNum = 23199797;BA.debugLine="Dim item As String = li.Get(i)";
_item = BA.ObjectToString(_li.Get(_i));
RDebugUtils.currentLine=23199798;
 //BA.debugLineNum = 23199798;BA.debugLine="Dim x As Int = item.ToLowerCase.IndexOf(full)";
_x = _item.toLowerCase().indexOf(_full);
RDebugUtils.currentLine=23199799;
 //BA.debugLineNum = 23199799;BA.debugLine="If x = -1 Then";
if (_x==-1) { 
RDebugUtils.currentLine=23199800;
 //BA.debugLineNum = 23199800;BA.debugLine="Continue";
if (true) continue;
 };
 }
};
RDebugUtils.currentLine=23199803;
 //BA.debugLineNum = 23199803;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=22609939;
 //BA.debugLineNum = 22609939;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=22675468;
 //BA.debugLineNum = 22675468;BA.debugLine="Dim sv As ScrollPane = CustomListView1.sv";
...
RDebugUtils.currentLine=22675469;
 //BA.debugLineNum = 22675469;BA.debugLine="sv.StyleClasses.Add(\"b4xdialog\")";
_sv.getStyleClasses().Add((Object)("b4xdialog"));
RDebugUtils.currentLine=22675470;
 //BA.debugLineNum = 22675470;BA.debugLine="sv.InnerNode.StyleClasses.Add(\"b4xdialog\")";
_sv.getInnerNode().getStyleClasses().Add((Object)("b4xdialog"));
RDebugUtils.currentLine=22675472;
 //BA.debugLineNum = 22675472;BA.debugLine="Dim jo As JavaObject = Me";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(this));
RDebugUtils.currentLine=22675473;
 //BA.debugLineNum = 22675473;BA.debugLine="jo.RunMethod(\"RemoveWarning\", Null)";
...
RDebugUtils.currentLine=22740994;
 //BA.debugLineNum = 22740994;BA.debugLine="CustomListView1.Base_Resize(Width, Height)";
...
RDebugUtils.currentLine=23068673;
 //BA.debugLineNum = 23068673;BA.debugLine="If CustomListView1.Size > 0 And LastTerm.Length >";
if (__ref._customlistview1 /*b4j.example.customlistview*/ ._getsize()>0 && __ref._lastterm /*String*/ .length()>0) { 
RDebugUtils.currentLine=23068674;
 //BA.debugLineNum = 23068674;BA.debugLine="CustomListView1_ItemClick(0, CustomListView1.Get";
...
RDebugUtils.currentLine=23330821;
 //BA.debugLineNum = 23330821;BA.debugLine="AllItems = obj(2)";
