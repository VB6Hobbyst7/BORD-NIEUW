...
//C
this.state = 1;
 //BA.debugLineNum = 335;BA.debugLine="Dim caroms, make As Int";
_caroms = 0;
_make = 0;
 //BA.debugLineNum = 337;BA.debugLine="caroms = lbl_player_one_100.Text&lbl_player_one_1";
_caroms = (int)(Double.parseDouble(parent._lbl_player_one_100.getText()+parent._lbl_player_one_10.getText()+parent._lbl_player_one_1.getText()));
 //BA.debugLineNum = 338;BA.debugLine="make = lbl_player_one_make_100.text&lbl_player_on";
_make = (int)(Double.parseDouble(parent._lbl_player_one_make_100.getText()+parent._lbl_player_one_make_10.getText()+parent._lbl_player_one_make_1.getText()));
 //BA.debugLineNum = 340;BA.debugLine="If make = 0 Then Return";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 342;BA.debugLine="If caroms >= make Then";
if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 343;BA.debugLine="lbl_game_text.Text = $\"Gelijkmakende beurt voor";
parent._lbl_game_text.setText(("Gelijkmakende beurt voor "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent._lbl_player_two_name.getText()))+""));
 //BA.debugLineNum = 344;BA.debugLine="pn_game.Top = (frm.RootPane.Height/2)-(pn_game.H";
parent._pn_game.setTop((parent._frm.getRootPane().getHeight()/(double)2)-(parent._pn_game.getHeight()/(double)2));
 //BA.debugLineNum = 345;BA.debugLine="setP2Name";
_setp2name();
 //BA.debugLineNum = 346;BA.debugLine="Sleep(4000)";
...
this.state = 10;
;
 //BA.debugLineNum = 347;BA.debugLine="pn_game.Top = 1650";
...
int _caroms = 0;
int _make = 0;
 //BA.debugLineNum = 351;BA.debugLine="Sub checkMatchWonP2";
 //BA.debugLineNum = 352;BA.debugLine="Dim caroms, make As Int";
_caroms = 0;
_make = 0;
 //BA.debugLineNum = 354;BA.debugLine="caroms = lbl_player_two_100.Text&lbl_player_two_1";
_caroms = (int)(Double.parseDouble(_lbl_player_two_100.getText()+_lbl_player_two_10.getText()+_lbl_player_two_1.getText()));
 //BA.debugLineNum = 355;BA.debugLine="make = lbl_player_two_make_100.text&lbl_player_tw";
_make = (int)(Double.parseDouble(_lbl_player_two_make_100.getText()+_lbl_player_two_make_10.getText()+_lbl_player_two_make_1.getText()));
 //BA.debugLineNum = 356;BA.debugLine="If make = 0 Then Return";
if (_make==0) { 
if (true) return "";};
 //BA.debugLineNum = 358;BA.debugLine="If caroms >= make Then";
if (_caroms>=_make) { 
 };
...
//C
this.state = -1;
 //BA.debugLineNum = 412;BA.debugLine="pn_promote.SetLayoutAnimated(0, x, y, pn_promote.";
...
public static String  _hideform(boolean _hide) throws Exception{
 //BA.debugLineNum = 371;BA.debugLine="Sub hideForm(hide As Boolean)";
 //BA.debugLineNum = 372;BA.debugLine="frm.rootpane.Visible = hide";
_frm.getRootPane().setVisible(_hide);
 //BA.debugLineNum = 373;BA.debugLine="End Sub";
return "";
}
public static String  _initpanels() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub initPanels";
 //BA.debugLineNum = 111;BA.debugLine="pn_promote_top = 1130 'pn_promote.Top";
_pn_promote_top = 1130;
 //BA.debugLineNum = 112;BA.debugLine="pn_promote_left = 20 'pn_promote.Left";
_pn_promote_left = 20;
 //BA.debugLineNum = 114;BA.debugLine="inactivecls.frm = frm";
_inactivecls._frm /*anywheresoftware.b4j.objects.Form*/  = _frm;
 //BA.debugLineNum = 115;BA.debugLine="inactivecls.pn_promote = pn_promote";
...
public static String  _lastclick() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub lastClick";
 //BA.debugLineNum = 171;BA.debugLine="inactivecls.lastClick = DateTime.Now";
...
public static String  _lbl_close_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 403;BA.debugLine="Sub lbl_close_MouseReleased (EventData As MouseEve";
 //BA.debugLineNum = 404;BA.debugLine="ExitApplication";
...
int _points = 0;
 //BA.debugLineNum = 202;BA.debugLine="Sub lbl_innings_MouseReleased (EventData As MouseE";
 //BA.debugLineNum = 203;BA.debugLine="Dim points As Int = lbl_innings.Text";
_points = (int)(Double.parseDouble(_lbl_innings.getText()));
 //BA.debugLineNum = 205;BA.debugLine="If EventData.PrimaryButtonPressed Then";
if (_eventdata.getPrimaryButtonPressed()) { 
 //BA.debugLineNum = 206;BA.debugLine="points = points + 1";
_points = (int) (_points+1);
 }else {
 //BA.debugLineNum = 208;BA.debugLine="points = points - 1";
_points = (int) (_points-1);
 };
 //BA.debugLineNum = 210;BA.debugLine="If points = -1 Then";
if (_points==-1) { 
 //BA.debugLineNum = 211;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 214;BA.debugLine="func.innigs = points";
_func._innigs /*int*/  = _points;
 //BA.debugLineNum = 215;BA.debugLine="lbl_innings.Text = func.padString(points, \"0\", 0,";
_lbl_innings.setText(_func._padstring /*String*/ (BA.NumberToString(_points),"0",(int) (0),(int) (3)));
 //BA.debugLineNum = 216;BA.debugLine="func.calcMoyenne(lbl_player_one_moyenne, lbl_play";
_func._calcmoyenne /*String*/ (_lbl_player_one_moyenne,_lbl_player_two_moyenne);
 //BA.debugLineNum = 217;BA.debugLine="func.processHs(\"all\")";
_func._processhs /*String*/ ("all");
 //BA.debugLineNum = 218;BA.debugLine="func.inngSet = 1";
...
public static String  _lbl_player_one_1_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub lbl_player_one_1_MouseReleased (EventData As M";
 //BA.debugLineNum = 175;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 176;BA.debugLine="func.calcScorePlayerOne(1, EventData.PrimaryButto";
...
public static String  _lbl_player_one_10_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub lbl_player_one_10_MouseReleased (EventData As";
 //BA.debugLineNum = 181;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 182;BA.debugLine="func.calcScorePlayerOne(10, EventData.PrimaryButt";
...
public static String  _lbl_player_one_100_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub lbl_player_one_100_MouseReleased (EventData As";
 //BA.debugLineNum = 185;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 186;BA.debugLine="func.calcScorePlayerOne(100, EventData.PrimaryBut";
...
public static String  _lbl_player_one_hs_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 546;BA.debugLine="Sub lbl_player_one_hs_MouseReleased (EventData As";
 //BA.debugLineNum = 547;BA.debugLine="lbl_player_one_hs.Text = func.setHs(lbl_player_on";
...
public static String  _lbl_player_one_make_1_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Sub lbl_player_one_make_1_MouseReleased (EventData";
 //BA.debugLineNum = 244;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 245;BA.debugLine="func.playerOneMake(lbl_player_one_make_100, lbl_p";
...
public static String  _lbl_player_one_make_10_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub lbl_player_one_make_10_MouseReleased (EventDat";
 //BA.debugLineNum = 238;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 239;BA.debugLine="func.playerOneMake(lbl_player_one_make_100, lbl_p";
...
public static String  _lbl_player_one_make_100_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub lbl_player_one_make_100_MouseReleased (EventDa";
 //BA.debugLineNum = 233;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 234;BA.debugLine="func.playerOneMake(lbl_player_one_make_100, lbl_p";
...
public static String  _lbl_player_one_name_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub lbl_player_one_name_MouseReleased (EventData A";
 //BA.debugLineNum = 222;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 223;BA.debugLine="func.processHs(\"all\")";
_func._processhs /*String*/ ("all");
...
public static String  _lbl_player_two_1_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub lbl_player_two_1_MouseReleased (EventData As M";
 //BA.debugLineNum = 190;BA.debugLine="setP2Name";
_setp2name();
 //BA.debugLineNum = 191;BA.debugLine="func.calcScorePlayertwo(1, EventData.PrimaryButto";
...
public static String  _lbl_player_two_10_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub lbl_player_two_10_MouseReleased (EventData As";
 //BA.debugLineNum = 194;BA.debugLine="setP2Name";
_setp2name();
 //BA.debugLineNum = 195;BA.debugLine="func.calcScorePlayertwo(10, EventData.PrimaryButt";
...
public static String  _lbl_player_two_100_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub lbl_player_two_100_MouseReleased (EventData As";
 //BA.debugLineNum = 198;BA.debugLine="setP2Name";
_setp2name();
 //BA.debugLineNum = 199;BA.debugLine="func.calcScorePlayertwo(100, EventData.PrimaryBut";
...
public static String  _lbl_player_two_hs_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 542;BA.debugLine="Sub lbl_player_two_hs_MouseReleased (EventData As";
 //BA.debugLineNum = 543;BA.debugLine="lbl_player_two_hs.Text = func.setHs(lbl_player_tw";
...
public static String  _lbl_player_two_make_1_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 265;BA.debugLine="Sub lbl_player_two_make_1_MouseReleased (EventData";
 //BA.debugLineNum = 266;BA.debugLine="func.playertwoMake(lbl_player_two_make_100, lbl_p";
...
public static String  _lbl_player_two_make_10_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Sub lbl_player_two_make_10_MouseReleased (EventDat";
...
public static String  _lbl_player_two_make_100_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 256;BA.debugLine="Sub lbl_player_two_make_100_MouseReleased (EventDa";
...
public static String  _lbl_player_two_name_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub lbl_player_two_name_MouseReleased (EventData A";
 //BA.debugLineNum = 227;BA.debugLine="setP2Name";
_setp2name();
 //BA.debugLineNum = 228;BA.debugLine="func.processHs(\"all\")";
_func._processhs /*String*/ ("all");
 //BA.debugLineNum = 229;BA.debugLine="func.inngSet = 0";
...
public static String  _lbl_reset_mouseentered(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 383;BA.debugLine="Sub lbl_reset_MouseEntered (EventData As MouseEven";
 //BA.debugLineNum = 384;BA.debugLine="lbl_reset.Color =  0xFF69D79A";
_lbl_reset.setColor((int) (0xff69d79a));
 //BA.debugLineNum = 385;BA.debugLine="lbl_reset.TextColor = 0xFFFFFF00";
...
public static String  _lbl_reset_mouseexited(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 388;BA.debugLine="Sub lbl_reset_MouseExited (EventData As MouseEvent";
 //BA.debugLineNum = 389;BA.debugLine="lbl_reset.Color = 0xFFFF0000";
_lbl_reset.setColor((int) (0xffff0000));
 //BA.debugLineNum = 390;BA.debugLine="lbl_reset.TextColor = 0xFFFFFFFF";
...
public static String  _lbl_reset_mousereleased(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 393;BA.debugLine="Sub lbl_reset_MouseReleased (EventData As MouseEve";
 //BA.debugLineNum = 394;BA.debugLine="inactivecls.lastClick = DateTime.Now";
_inactivecls._lastclick /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 395;BA.debugLine="If func.newGameInitialized = False Then";
if (_func._newgameinitialized /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 396;BA.debugLine="CallSub(nieuwe_partij, \"show\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(ba,(Object)(_nieuwe_partij.getObject()),"show");
 }else {
 //BA.debugLineNum = 398;BA.debugLine="CallSub(nieuwe_partij, \"showForm\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(ba,(Object)(_nieuwe_partij.getObject()),"showForm");
 };
 //BA.debugLineNum = 400;BA.debugLine="nieuwePartij";
_nieuwepartij();
...
anywheresoftware.b4a.objects.collections.List _list = null;
 //BA.debugLineNum = 156;BA.debugLine="Sub lstPlayerOneScoreLbl As List";
 //BA.debugLineNum = 157;BA.debugLine="Dim List As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 158;BA.debugLine="List.Initialize";
_list.Initialize();
 //BA.debugLineNum = 159;BA.debugLine="List.AddAll(Array As Object(lbl_player_one_1, lbl";
...
anywheresoftware.b4a.objects.collections.List _list = null;
 //BA.debugLineNum = 163;BA.debugLine="Sub lstPlayerTwoScoreLbl As List";
 //BA.debugLineNum = 164;BA.debugLine="Dim List As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 165;BA.debugLine="List.Initialize";
_list.Initialize();
 //BA.debugLineNum = 166;BA.debugLine="List.AddAll(Array As Object(lbl_player_two_1, lbl";
_list.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_lbl_player_two_1.getObject()),(Object)(_lbl_player_two_10.getObject()),(Object)(_lbl_player_two_100.getObject()),(Object)(_lbl_player_two_moyenne.getObject()),(Object)(_b4xprogressbarp2)}));
 //BA.debugLineNum = 167;BA.debugLine="Return List";
if (true) return _list;
...
public static String  _mainform_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 443;BA.debugLine="Sub MainForm_MouseClicked (EventData As MouseEvent";
 //BA.debugLineNum = 444;BA.debugLine="If inactivecls.tmr_draw_promote.Enabled = True Th";
if (_inactivecls._tmr_draw_promote /*anywheresoftware.b4a.objects.Timer*/ .getEnabled()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 445;BA.debugLine="pn_promote.Top = pn_promote_top";
_pn_promote.setTop(_pn_promote_top);
 //BA.debugLineNum = 446;BA.debugLine="pn_promote_left = pn_promote_left";
_pn_promote_left = _pn_promote_left;
 //BA.debugLineNum = 448;BA.debugLine="inactivecls.lastClick = DateTime.Now";
_inactivecls._lastclick /*long*/  = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 449;BA.debugLine="inactivecls.enableTime(True)";
_inactivecls._enabletime /*String*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 450;BA.debugLine="inactivecls.enablePromote(False)";
...
//C
this.state = 1;
 //BA.debugLineNum = 421;BA.debugLine="If promoteRunning = True Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 422;BA.debugLine="pn_promote.Top = pn_promote_top";
parent._pn_promote.setTop(parent._pn_promote_top);
 //BA.debugLineNum = 423;BA.debugLine="pn_promote.left = pn_promote_left";
...
public static String  _mouseover(anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper _n1) throws Exception{
 //BA.debugLineNum = 433;BA.debugLine="private Sub MouseOver(n1 As Node)";
 //BA.debugLineNum = 435;BA.debugLine="setHandler(n1,\"setOnMouseMoved\",\"mouseIn\")";
_sethandler((anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_n1.getObject())),"setOnMouseMoved","mouseIn");
 //BA.debugLineNum = 436;BA.debugLine="setHandler(n1,\"setOnMouseExited\",\"mouseOut\")";
...
public static String  _nieuwepartij() throws Exception{
 //BA.debugLineNum = 375;BA.debugLine="Sub nieuwePartij";
 //BA.debugLineNum = 376;BA.debugLine="If func.newGameInitialized = False Then";
if (_func._newgameinitialized /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 377;BA.debugLine="nieuwe_partij.show";
_nieuwe_partij._show /*String*/ ();
 }else {
 //BA.debugLineNum = 379;BA.debugLine="CallSub(nieuwe_partij, \"showForm\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(ba,(Object)(_nieuwe_partij.getObject()),"showForm");
 };
...
public static String  _playeroneperc(String _perc) throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub playerOnePerc(perc As String)";
 //BA.debugLineNum = 249;BA.debugLine="lbl_player_one_perc.Text = perc";
_lbl_player_one_perc.setText(_perc);
 //BA.debugLineNum = 250;BA.debugLine="End Sub";
return "";
}
public static String  _playertwoperc(String _perc) throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub playerTwoPerc(perc As String)";
 //BA.debugLineNum = 253;BA.debugLine="lbl_player_two_perc.Text = perc";
...
_clstoast = new b4j.example.clxtoastmessage();
 //BA.debugLineNum = 8;BA.debugLine="Private clsUpdate As classUpdate";
...
_lbl_game_text = new anywheresoftware.b4j.objects.LabelWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Private lbl_ip As Label";
_lbl_ip = new anywheresoftware.b4j.objects.LabelWrapper();
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public static String  _resetboard() throws Exception{
 //BA.debugLineNum = 269;BA.debugLine="Sub resetBoard";
 //BA.debugLineNum = 270;BA.debugLine="lbl_player_one_1.Text = \"0\"";
_lbl_player_one_1.setText("0");
 //BA.debugLineNum = 271;BA.debugLine="lbl_player_one_10.Text = \"0\"";
_lbl_player_one_10.setText("0");
 //BA.debugLineNum = 272;BA.debugLine="lbl_player_one_100.Text = \"0\"";
_lbl_player_one_100.setText("0");
 //BA.debugLineNum = 273;BA.debugLine="lbl_player_one_make_100.Text = \"0\"";
_lbl_player_one_make_100.setText("0");
 //BA.debugLineNum = 274;BA.debugLine="lbl_player_one_make_10.Text = \"0\"";
_lbl_player_one_make_10.setText("0");
 //BA.debugLineNum = 275;BA.debugLine="lbl_player_one_make_1.Text = \"0\"";
_lbl_player_one_make_1.setText("0");
 //BA.debugLineNum = 276;BA.debugLine="lbl_player_one_moyenne.Text = \"0.000\"";
_lbl_player_one_moyenne.setText("0.000");
 //BA.debugLineNum = 277;BA.debugLine="lbl_player_one_perc.Text = \"0.00%\"";
_lbl_player_one_perc.setText("0.00%");
 //BA.debugLineNum = 279;BA.debugLine="lbl_innings.Text = \"000\"";
_lbl_innings.setText("000");
 //BA.debugLineNum = 281;BA.debugLine="lbl_player_two_100.Text = \"0\"";
_lbl_player_two_100.setText("0");
 //BA.debugLineNum = 282;BA.debugLine="lbl_player_two_10.Text = \"0\"";
_lbl_player_two_10.setText("0");
 //BA.debugLineNum = 283;BA.debugLine="lbl_player_two_1.Text = \"0\"";
_lbl_player_two_1.setText("0");
 //BA.debugLineNum = 284;BA.debugLine="lbl_player_two_make_100.Text = \"0\"";
_lbl_player_two_make_100.setText("0");
 //BA.debugLineNum = 285;BA.debugLine="lbl_player_two_make_10.Text = \"0\"";
_lbl_player_two_make_10.setText("0");
 //BA.debugLineNum = 286;BA.debugLine="lbl_player_two_make_1.Text = \"0\"";
_lbl_player_two_make_1.setText("0");
 //BA.debugLineNum = 287;BA.debugLine="lbl_player_two_perc.Text = \"0.00%\"";
_lbl_player_two_perc.setText("0.00%");
 //BA.debugLineNum = 288;BA.debugLine="lbl_player_two_moyenne.Text = \"0.000\"";
_lbl_player_two_moyenne.setText("0.000");
 //BA.debugLineNum = 289;BA.debugLine="lbl_player_one_hs.Text = \"000\"";
_lbl_player_one_hs.setText("000");
 //BA.debugLineNum = 290;BA.debugLine="lbl_player_two_hs.Text = \"000\"";
_lbl_player_two_hs.setText("000");
 //BA.debugLineNum = 292;BA.debugLine="func.inngSet = 0";
_func._inngset /*int*/  = (int) (0);
 //BA.debugLineNum = 293;BA.debugLine="func.innigs = 0";
_func._innigs /*int*/  = (int) (0);
 //BA.debugLineNum = 294;BA.debugLine="func.scorePlayerOne = 0";
_func._scoreplayerone /*int*/  = (int) (0);
 //BA.debugLineNum = 295;BA.debugLine="func.scorePlayerTwo = 0";
_func._scoreplayertwo /*int*/  = (int) (0);
 //BA.debugLineNum = 296;BA.debugLine="func.playerOneToMake = 0";
_func._playeronetomake /*int*/  = (int) (0);
 //BA.debugLineNum = 297;BA.debugLine="func.playertwoToMake = 0";
_func._playertwotomake /*int*/  = (int) (0);
 //BA.debugLineNum = 298;BA.debugLine="func.playerOneHs = 0";
_func._playeronehs /*int*/  = (int) (0);
 //BA.debugLineNum = 299;BA.debugLine="func.playerTwoHs = 0";
_func._playertwohs /*int*/  = (int) (0);
 //BA.debugLineNum = 300;BA.debugLine="func.p1HsTemp = 0";
_func._p1hstemp /*int*/  = (int) (0);
 //BA.debugLineNum = 301;BA.debugLine="func.p2HsTemp = 0";
_func._p2hstemp /*int*/  = (int) (0);
 //BA.debugLineNum = 302;BA.debugLine="B4XProgressBarP1.Progress = 0";
_b4xprogressbarp1._setprogress /*float*/ ((float) (0));
 //BA.debugLineNum = 303;BA.debugLine="B4XProgressBarP2.Progress = 0";
_b4xprogressbarp2._setprogress /*float*/ ((float) (0));
 //BA.debugLineNum = 304;BA.debugLine="setP1Name";
_setp1name();
 //BA.debugLineNum = 306;BA.debugLine="End Sub";
return "";
}
public static String  _setclearboard(boolean _clear) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Public Sub setClearBoard(clear As Boolean)";
 //BA.debugLineNum = 107;BA.debugLine="func.setNieuwePartij = clear";
_func._setnieuwepartij /*boolean*/  = _clear;
 //BA.debugLineNum = 108;BA.debugLine="End Sub";
return "";
}
public static String  _setfontstyle() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Sub setFontStyle";
 //BA.debugLineNum = 122;BA.debugLine="func.caromLabelCss(lbl_player_one_hs, \"labelWhite";
_func._caromlabelcss /*String*/ (_lbl_player_one_hs,"labelWhite");
 //BA.debugLineNum = 123;BA.debugLine="func.caromLabelCss(lbl_player_one_moyenne, \"label";
_func._caromlabelcss /*String*/ (_lbl_player_one_moyenne,"labelWhite");
 //BA.debugLineNum = 124;BA.debugLine="func.caromLabelCss(lbl_player_one_perc, \"labelWhi";
_func._caromlabelcss /*String*/ (_lbl_player_one_perc,"labelWhite");
 //BA.debugLineNum = 125;BA.debugLine="func.caromLabelCss(lbl_player_two_hs, \"labelWhite";
_func._caromlabelcss /*String*/ (_lbl_player_two_hs,"labelWhite");
 //BA.debugLineNum = 126;BA.debugLine="func.caromLabelCss(lbl_player_two_moyenne, \"label";
_func._caromlabelcss /*String*/ (_lbl_player_two_moyenne,"labelWhite");
 //BA.debugLineNum = 127;BA.debugLine="func.caromLabelCss(lbl_player_two_perc, \"labelWhi";
_func._caromlabelcss /*String*/ (_lbl_player_two_perc,"labelWhite");
 //BA.debugLineNum = 129;BA.debugLine="func.caromLabelCss(lbl_innings, \"labelCarom\")";
_func._caromlabelcss /*String*/ (_lbl_innings,"labelCarom");
 //BA.debugLineNum = 131;BA.debugLine="func.caromLabelCss(lbl_player_one_100, \"labelCaro";
_func._caromlabelcss /*String*/ (_lbl_player_one_100,"labelCarom");
 //BA.debugLineNum = 132;BA.debugLine="func.caromLabelCss(lbl_player_one_10, \"labelCarom";
_func._caromlabelcss /*String*/ (_lbl_player_one_10,"labelCarom");
 //BA.debugLineNum = 133;BA.debugLine="func.caromLabelCss(lbl_player_one_1, \"labelCarom\"";
_func._caromlabelcss /*String*/ (_lbl_player_one_1,"labelCarom");
 //BA.debugLineNum = 135;BA.debugLine="func.caromLabelCss(lbl_player_one_make_100, \"labe";
_func._caromlabelcss /*String*/ (_lbl_player_one_make_100,"labelCarom");
 //BA.debugLineNum = 136;BA.debugLine="func.caromLabelCss(lbl_player_one_make_10, \"label";
_func._caromlabelcss /*String*/ (_lbl_player_one_make_10,"labelCarom");
 //BA.debugLineNum = 137;BA.debugLine="func.caromLabelCss(lbl_player_one_make_1, \"labelC";
_func._caromlabelcss /*String*/ (_lbl_player_one_make_1,"labelCarom");
 //BA.debugLineNum = 139;BA.debugLine="func.caromLabelCss(lbl_player_two_100, \"labelCaro";
_func._caromlabelcss /*String*/ (_lbl_player_two_100,"labelCarom");
 //BA.debugLineNum = 140;BA.debugLine="func.caromLabelCss(lbl_player_two_10, \"labelCarom";
_func._caromlabelcss /*String*/ (_lbl_player_two_10,"labelCarom");
 //BA.debugLineNum = 141;BA.debugLine="func.caromLabelCss(lbl_player_two_1, \"labelCarom\"";
_func._caromlabelcss /*String*/ (_lbl_player_two_1,"labelCarom");
 //BA.debugLineNum = 143;BA.debugLine="func.caromLabelCss(lbl_player_two_make_100, \"labe";
_func._caromlabelcss /*String*/ (_lbl_player_two_make_100,"labelCarom");
 //BA.debugLineNum = 144;BA.debugLine="func.caromLabelCss(lbl_player_two_make_10, \"label";
_func._caromlabelcss /*String*/ (_lbl_player_two_make_10,"labelCarom");
 //BA.debugLineNum = 145;BA.debugLine="func.caromLabelCss(lbl_player_two_make_1, \"labelC";
_func._caromlabelcss /*String*/ (_lbl_player_two_make_1,"labelCarom");
 //BA.debugLineNum = 147;BA.debugLine="resetBoard";
_resetboard();
...
public static String  _sethandler(anywheresoftware.b4j.object.JavaObject _ob,String _eventname,String _handlername) throws Exception{
 //BA.debugLineNum = 439;BA.debugLine="private Sub setHandler(ob As JavaObject,eventName";
 //BA.debugLineNum = 440;BA.debugLine="ob.RunMethod(eventName, Array(ob.CreateEventFromU";
...
public static String  _setmessage(anywheresoftware.b4a.objects.collections.List _msglist) throws Exception{
 //BA.debugLineNum = 515;BA.debugLine="Sub setMessage(msgList As List)";
 //BA.debugLineNum = 516;BA.debugLine="lbl_message_1.Text = msgList.get(0)";
_lbl_message_1.setText(BA.ObjectToString(_msglist.Get((int) (0))));
 //BA.debugLineNum = 517;BA.debugLine="lbl_message_2.Text = msgList.get(1)";
_lbl_message_2.setText(BA.ObjectToString(_msglist.Get((int) (1))));
 //BA.debugLineNum = 518;BA.debugLine="lbl_message_3.Text = msgList.get(2)";
_lbl_message_3.setText(BA.ObjectToString(_msglist.Get((int) (2))));
 //BA.debugLineNum = 519;BA.debugLine="lbl_message_4.Text = msgList.get(3)";
_lbl_message_4.setText(BA.ObjectToString(_msglist.Get((int) (3))));
 //BA.debugLineNum = 520;BA.debugLine="lbl_message_5.Text = msgList.Get(4)";
...
public static String  _setp1name() throws Exception{
 //BA.debugLineNum = 308;BA.debugLine="Sub setP1Name";
 //BA.debugLineNum = 309;BA.debugLine="lbl_player_one_name.Color = 0xff3455db'0xFF69D79A";
_lbl_player_one_name.setColor((int) (0xff3455db));
 //BA.debugLineNum = 310;BA.debugLine="lbl_player_two_name.Color = 0xFF001A01";
_lbl_player_two_name.setColor((int) (0xff001a01));
 //BA.debugLineNum = 312;BA.debugLine="lbl_player_one_100.Enabled = True";
_lbl_player_one_100.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 313;BA.debugLine="lbl_player_one_10.Enabled = True";
_lbl_player_one_10.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 314;BA.debugLine="lbl_player_one_1.Enabled = True";
_lbl_player_one_1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 316;BA.debugLine="lbl_player_two_100.Enabled = False";
_lbl_player_two_100.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 317;BA.debugLine="lbl_player_two_10.Enabled = False";
_lbl_player_two_10.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 318;BA.debugLine="lbl_player_two_1.Enabled = False";
...
public static String  _setp2name() throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Sub setP2Name";
 //BA.debugLineNum = 322;BA.debugLine="lbl_player_two_name.Color = 0xff3455db'0xFF69D79A";
_lbl_player_two_name.setColor((int) (0xff3455db));
 //BA.debugLineNum = 323;BA.debugLine="lbl_player_one_name.Color = 0xFF001A01";
_lbl_player_one_name.setColor((int) (0xff001a01));
 //BA.debugLineNum = 325;BA.debugLine="lbl_player_one_100.Enabled = False";
_lbl_player_one_100.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 326;BA.debugLine="lbl_player_one_10.Enabled = False";
_lbl_player_one_10.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 327;BA.debugLine="lbl_player_one_1.Enabled = False";
_lbl_player_one_1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 329;BA.debugLine="lbl_player_two_100.Enabled = True";
_lbl_player_two_100.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 330;BA.debugLine="lbl_player_two_10.Enabled = True";
_lbl_player_two_10.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 331;BA.debugLine="lbl_player_two_1.Enabled = True";
...
public static String  _setpromoterunning(boolean _running) throws Exception{
 //BA.debugLineNum = 416;BA.debugLine="Sub setPromoteRunning(running As Boolean)";
 //BA.debugLineNum = 417;BA.debugLine="promoteRunning = running";
...
String _temaken = "";
 //BA.debugLineNum = 523;BA.debugLine="Sub setSpelerData(data As List)";
 //BA.debugLineNum = 524;BA.debugLine="resetBoard";
_resetboard();
 //BA.debugLineNum = 525;BA.debugLine="Dim teMaken As String";
_temaken = "";
 //BA.debugLineNum = 526;BA.debugLine="lbl_player_one_name.Text = data.Get(0)";
_lbl_player_one_name.setText(BA.ObjectToString(_data.Get((int) (0))));
 //BA.debugLineNum = 527;BA.debugLine="func.playerOneToMake = data.Get(1)";
_func._playeronetomake /*int*/  = (int)(BA.ObjectToNumber(_data.Get((int) (1))));
 //BA.debugLineNum = 528;BA.debugLine="teMaken =  func.padString(data.Get(1), \"0\", 0, 3)";
_temaken = _func._padstring /*String*/ (BA.ObjectToString(_data.Get((int) (1))),"0",(int) (0),(int) (3));
 //BA.debugLineNum = 529;BA.debugLine="lbl_player_one_make_100.Text	= teMaken.SubString2";
_lbl_player_one_make_100.setText(_temaken.substring((int) (0),(int) (1)));
 //BA.debugLineNum = 530;BA.debugLine="lbl_player_one_make_10.Text		= teMaken.SubString2";
_lbl_player_one_make_10.setText(_temaken.substring((int) (1),(int) (2)));
 //BA.debugLineNum = 531;BA.debugLine="lbl_player_one_make_1.Text		= teMaken.SubString2(";
_lbl_player_one_make_1.setText(_temaken.substring((int) (2),(int) (3)));
 //BA.debugLineNum = 533;BA.debugLine="lbl_player_two_name.Text = data.Get(2)";
_lbl_player_two_name.setText(BA.ObjectToString(_data.Get((int) (2))));
 //BA.debugLineNum = 534;BA.debugLine="teMaken =  func.padString(data.Get(3), \"0\", 0, 3)";
_temaken = _func._padstring /*String*/ (BA.ObjectToString(_data.Get((int) (3))),"0",(int) (0),(int) (3));
 //BA.debugLineNum = 535;BA.debugLine="func.playerTwoToMake = data.Get(3)";
_func._playertwotomake /*int*/  = (int)(BA.ObjectToNumber(_data.Get((int) (3))));
 //BA.debugLineNum = 536;BA.debugLine="lbl_player_two_make_100.Text	= teMaken.SubString2";
_lbl_player_two_make_100.setText(_temaken.substring((int) (0),(int) (1)));
 //BA.debugLineNum = 537;BA.debugLine="lbl_player_two_make_10.Text		= teMaken.SubString2";
_lbl_player_two_make_10.setText(_temaken.substring((int) (1),(int) (2)));
 //BA.debugLineNum = 538;BA.debugLine="lbl_player_two_make_1.Text		= teMaken.SubString2(";
...
//C
this.state = 1;
 //BA.debugLineNum = 56;BA.debugLine="frm.Initialize(\"frm\", 1920, 1080)";
parent._frm.Initialize(ba,"frm",1920,1080);
 //BA.debugLineNum = 57;BA.debugLine="frm.RootPane.LoadLayout(\"scorebord\")";
parent._frm.getRootPane().LoadLayout(ba,"scorebord");
 //BA.debugLineNum = 58;BA.debugLine="frm.BackColor  =   fx.Colors.From32Bit(0xFF001A01";
parent._frm.setBackColor((javafx.scene.paint.Paint)(parent._fx.Colors.From32Bit((int) (0xff001a01))));
 //BA.debugLineNum = 59;BA.debugLine="lbl_ip.Text = func.getIpNumber";
parent._lbl_ip.setText(parent._func._getipnumber /*String*/ ());
 //BA.debugLineNum = 65;BA.debugLine="frm.SetFormStyle(\"UNDECORATED\")";
parent._frm.SetFormStyle("UNDECORATED");
 //BA.debugLineNum = 66;BA.debugLine="frm.Resizable = False";
parent._frm.setResizable(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 69;BA.debugLine="frm.Stylesheets.Add(File.GetUri(File.DirAssets, \"";
parent._frm.getStylesheets().Add((Object)(anywheresoftware.b4a.keywords.Common.File.GetUri(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"n205.css")));
 //BA.debugLineNum = 70;BA.debugLine="parseConfig.pullConfig";
parent._parseconfig._pullconfig /*String*/ ();
 //BA.debugLineNum = 71;BA.debugLine="MouseOver(frm.RootPane)";
_mouseover((anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper(), (javafx.scene.Node)(parent._frm.getRootPane().getObject())));
 //BA.debugLineNum = 74;BA.debugLine="func.SetCustomCursor1(File.DirAssets, \"mouse.png\"";
parent._func._setcustomcursor1 /*String*/ (anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"mouse.png",370,370,(anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper(), (javafx.scene.Node)(parent._frm.getRootPane().getObject())));
 //BA.debugLineNum = 76;BA.debugLine="clsTmr.Initialize(lbl_clock)";
parent._clstmr._initialize /*String*/ (ba,(anywheresoftware.b4j.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.LabelWrapper(), (javafx.scene.control.Label)(parent._lbl_clock.getObject())));
 //BA.debugLineNum = 77;BA.debugLine="inactivecls.Initialize(870, 510)";
parent._inactivecls._initialize /*String*/ (ba,870,510);
 //BA.debugLineNum = 78;BA.debugLine="clsCheckCfg.Initialize";
parent._clscheckcfg._initialize /*String*/ (ba);
 //BA.debugLineNum = 79;BA.debugLine="clsToast.Initialize(frm.RootPane)";
parent._clstoast._initialize /*String*/ (ba,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent._frm.getRootPane().getObject())));
 //BA.debugLineNum = 83;BA.debugLine="lbl_version.Text = func.getVersion";
parent._lbl_version.setText(parent._func._getversion /*String*/ ());
 //BA.debugLineNum = 84;BA.debugLine="func.lblInnings = lbl_innings";
parent._func._lblinnings /*anywheresoftware.b4j.objects.LabelWrapper*/  = parent._lbl_innings;
 //BA.debugLineNum = 85;BA.debugLine="func.lbl_player_one_hs = lbl_player_one_hs";
parent._func._lbl_player_one_hs /*anywheresoftware.b4j.objects.LabelWrapper*/  = parent._lbl_player_one_hs;
 //BA.debugLineNum = 86;BA.debugLine="func.lbl_player_two_hs = lbl_player_two_hs";
parent._func._lbl_player_two_hs /*anywheresoftware.b4j.objects.LabelWrapper*/  = parent._lbl_player_two_hs;
 //BA.debugLineNum = 88;BA.debugLine="func.setP1CaromLables(lstPlayerOneScoreLbl)";
parent._func._setp1caromlables /*String*/ (_lstplayeronescorelbl());
 //BA.debugLineNum = 89;BA.debugLine="func.setP2CaromLables(lstPlayerTwoScoreLbl)";
parent._func._setp2caromlables /*String*/ (_lstplayertwoscorelbl());
 //BA.debugLineNum = 91;BA.debugLine="Wait For (funcInet.testInet) Complete (result As";
...
;
 //BA.debugLineNum = 92;BA.debugLine="If result Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 93;BA.debugLine="func.hasInternetAccess = True";
...
//C
this.state = 6;
 //BA.debugLineNum = 96;BA.debugLine="func.hasInternetAccess = False";
...
this.state = -1;
;
 //BA.debugLineNum = 99;BA.debugLine="initPanels";
_initpanels();
 //BA.debugLineNum = 100;BA.debugLine="frm.Show";
parent._frm.Show();
 //BA.debugLineNum = 101;BA.debugLine="setFontStyle";
_setfontstyle();
...
public static String  _showpromote() throws Exception{
 //BA.debugLineNum = 407;BA.debugLine="Sub showPromote";
 //BA.debugLineNum = 408;BA.debugLine="pn_promote.SetLayoutAnimated(0, 50dip, 50dip, pn_";
...
public static String  _showsponor(boolean _enabled) throws Exception{
 //BA.debugLineNum = 511;BA.debugLine="Sub showSponor(enabled As Boolean)";
 //BA.debugLineNum = 512;BA.debugLine="pn_sponsore.Visible = enabled";
...
//C
this.state = -1;
 //BA.debugLineNum = 455;BA.debugLine="inactivecls.updatePromote";
parent._inactivecls._updatepromote /*String*/ ();
 //BA.debugLineNum = 456;BA.debugLine="lbl_config_update.Visible = True";
parent._lbl_config_update.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 457;BA.debugLine="Sleep(5000)";
...
this.state = -1;
;
 //BA.debugLineNum = 458;BA.debugLine="lbl_config_update.Visible = False";
...
int _fsmake = 0;
int _fsinnings = 0;
 //BA.debugLineNum = 461;BA.debugLine="Sub useDigitalFont(useDigital As Boolean)";
 //BA.debugLineNum = 462;BA.debugLine="Dim fsCarom, fsMake, fsInnings As Int";
_fscarom = 0;
_fsmake = 0;
_fsinnings = 0;
 //BA.debugLineNum = 464;BA.debugLine="If useDigital Then";
if (_usedigital) { 
 //BA.debugLineNum = 465;BA.debugLine="fsCarom = 300'350";
_fscarom = (int) (300);
 //BA.debugLineNum = 466;BA.debugLine="fsMake = 225";
_fsmake = (int) (225);
 //BA.debugLineNum = 467;BA.debugLine="fsInnings = 250'300";
_fsinnings = (int) (250);
 }else {
 //BA.debugLineNum = 469;BA.debugLine="fsCarom = 225";
_fscarom = (int) (225);
 //BA.debugLineNum = 470;BA.debugLine="fsMake = 150";
_fsmake = (int) (150);
 //BA.debugLineNum = 471;BA.debugLine="fsInnings = 200";
_fsinnings = (int) (200);
 };
 //BA.debugLineNum = 474;BA.debugLine="func.setFont(lbl_player_one_1, fsCarom, useDigita";
_func._setfont /*String*/ (_lbl_player_one_1,_fscarom,_usedigital);
 //BA.debugLineNum = 475;BA.debugLine="func.setFont(lbl_player_one_10, fsCarom, useDigit";
_func._setfont /*String*/ (_lbl_player_one_10,_fscarom,_usedigital);
 //BA.debugLineNum = 476;BA.debugLine="func.setFont(lbl_player_one_100, fsCarom, useDigi";
_func._setfont /*String*/ (_lbl_player_one_100,_fscarom,_usedigital);
 //BA.debugLineNum = 477;BA.debugLine="func.setFont(lbl_player_two_1, fsCarom, useDigita";
_func._setfont /*String*/ (_lbl_player_two_1,_fscarom,_usedigital);
 //BA.debugLineNum = 478;BA.debugLine="func.setFont(lbl_player_two_10, fsCarom, useDigit";
_func._setfont /*String*/ (_lbl_player_two_10,_fscarom,_usedigital);
 //BA.debugLineNum = 479;BA.debugLine="func.setFont(lbl_player_two_100, fsCarom, useDigi";
_func._setfont /*String*/ (_lbl_player_two_100,_fscarom,_usedigital);
 //BA.debugLineNum = 480;BA.debugLine="func.setFont(lbl_innings, fsInnings, useDigital)";
_func._setfont /*String*/ (_lbl_innings,_fsinnings,_usedigital);
 //BA.debugLineNum = 481;BA.debugLine="func.setFont(lbl_player_one_make_100, fsMake, use";
_func._setfont /*String*/ (_lbl_player_one_make_100,_fsmake,_usedigital);
 //BA.debugLineNum = 482;BA.debugLine="func.setFont(lbl_player_one_make_10, fsMake, useD";
_func._setfont /*String*/ (_lbl_player_one_make_10,_fsmake,_usedigital);
 //BA.debugLineNum = 483;BA.debugLine="func.setFont(lbl_player_one_make_1, fsMake, useDi";
_func._setfont /*String*/ (_lbl_player_one_make_1,_fsmake,_usedigital);
 //BA.debugLineNum = 484;BA.debugLine="func.setFont(lbl_player_two_make_100,fsMake, useD";
_func._setfont /*String*/ (_lbl_player_two_make_100,_fsmake,_usedigital);
 //BA.debugLineNum = 485;BA.debugLine="func.setFont(lbl_player_two_make_10,fsMake, useDi";
_func._setfont /*String*/ (_lbl_player_two_make_10,_fsmake,_usedigital);
 //BA.debugLineNum = 486;BA.debugLine="func.setFont(lbl_player_two_make_1,fsMake, useDig";
...
public static String  _usefontyellow(boolean _useyellow) throws Exception{
 //BA.debugLineNum = 490;BA.debugLine="Sub useFontYellow(useYellow As Boolean)";
 //BA.debugLineNum = 492;BA.debugLine="func.setFontColor(lbl_innings, useYellow)";
_func._setfontcolor /*String*/ (_lbl_innings,_useyellow);
 //BA.debugLineNum = 494;BA.debugLine="func.setFontColor(lbl_player_one_1, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_one_1,_useyellow);
 //BA.debugLineNum = 495;BA.debugLine="func.setFontColor(lbl_player_one_10, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_one_10,_useyellow);
 //BA.debugLineNum = 496;BA.debugLine="func.setFontColor(lbl_player_one_100, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_one_100,_useyellow);
 //BA.debugLineNum = 498;BA.debugLine="func.setFontColor(lbl_player_two_1, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_two_1,_useyellow);
 //BA.debugLineNum = 499;BA.debugLine="func.setFontColor(lbl_player_two_10, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_two_10,_useyellow);
 //BA.debugLineNum = 500;BA.debugLine="func.setFontColor(lbl_player_two_100, useYellow)";
_func._setfontcolor /*String*/ (_lbl_player_two_100,_useyellow);
 //BA.debugLineNum = 502;BA.debugLine="func.setFontColor(lbl_player_one_make_100, useYel";
_func._setfontcolor /*String*/ (_lbl_player_one_make_100,_useyellow);
 //BA.debugLineNum = 503;BA.debugLine="func.setFontColor(lbl_player_one_make_10, useYell";
_func._setfontcolor /*String*/ (_lbl_player_one_make_10,_useyellow);
 //BA.debugLineNum = 504;BA.debugLine="func.setFontColor(lbl_player_one_make_1, useYello";
_func._setfontcolor /*String*/ (_lbl_player_one_make_1,_useyellow);
 //BA.debugLineNum = 506;BA.debugLine="func.setFontColor(lbl_player_two_make_100, useYel";
_func._setfontcolor /*String*/ (_lbl_player_two_make_100,_useyellow);
 //BA.debugLineNum = 507;BA.debugLine="func.setFontColor(lbl_player_two_make_10, useYell";
_func._setfontcolor /*String*/ (_lbl_player_two_make_10,_useyellow);
 //BA.debugLineNum = 508;BA.debugLine="func.setFontColor(lbl_player_two_make_1, useYello";
