...
RDebugUtils.currentLine=25231360;
 //BA.debugLineNum = 25231360;BA.debugLine="Private Sub Base_Resize (Width1 As Double, Height1";
...
RDebugUtils.currentLine=24576005;
 //BA.debugLineNum = 24576005;BA.debugLine="Private OnColor, OffColor As BCBrush";
_oncolor = new b4j.example.bcpath._bcbrush();
_offcolor = new b4j.example.bcpath._bcbrush();
RDebugUtils.currentLine=24576006;
 //BA.debugLineNum = 24576006;BA.debugLine="Private bc As BitmapCreator";
_bc = new b4j.example.bitmapcreator();
RDebugUtils.currentLine=24576007;
 //BA.debugLineNum = 24576007;BA.debugLine="Private Width As Int = 55dip";
_width = __c.DipToCurrent((int) (55));
RDebugUtils.currentLine=24576008;
 //BA.debugLineNum = 24576008;BA.debugLine="Private Height As Int = 31dip";
_height = __c.DipToCurrent((int) (31));
RDebugUtils.currentLine=24576009;
 //BA.debugLineNum = 24576009;BA.debugLine="Private ThumbColor As BCBrush";
_thumbcolor = new b4j.example.bcpath._bcbrush();
RDebugUtils.currentLine=24576010;
 //BA.debugLineNum = 24576010;BA.debugLine="Private iv As ImageView";
_iv = new anywheresoftware.b4j.objects.ImageViewWrapper();
RDebugUtils.currentLine=24576011;
 //BA.debugLineNum = 24576011;BA.debugLine="Private mValue As Boolean";
_mvalue = false;
RDebugUtils.currentLine=24576012;
 //BA.debugLineNum = 24576012;BA.debugLine="Private transparent As BCBrush";
_transparent = new b4j.example.bcpath._bcbrush();
RDebugUtils.currentLine=24576013;
 //BA.debugLineNum = 24576013;BA.debugLine="Private LoopIndex As Int";
_loopindex = 0;
RDebugUtils.currentLine=24576014;
 //BA.debugLineNum = 24576014;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=24576015;
 //BA.debugLineNum = 24576015;BA.debugLine="Private Scale As Float";
_scale = 0f;
RDebugUtils.currentLine=24576016;
 //BA.debugLineNum = 24576016;BA.debugLine="Private mEnabled As Boolean = True";
_menabled = __c.True;
...
RDebugUtils.currentLine=24707075;
 //BA.debugLineNum = 24707075;BA.debugLine="mBase.SetLayoutAnimated(0, mBase.Left, mBase.Top,";
...
RDebugUtils.currentLine=24707076;
 //BA.debugLineNum = 24707076;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,0,(int) (0),0);
RDebugUtils.currentLine=24707077;
 //BA.debugLineNum = 24707077;BA.debugLine="Dim pnl As B4XView = xui.CreatePanel(\"pnl\")";
...
RDebugUtils.currentLine=24707078;
 //BA.debugLineNum = 24707078;BA.debugLine="pnl.Color = xui.Color_Transparent";
...
RDebugUtils.currentLine=24707079;
 //BA.debugLineNum = 24707079;BA.debugLine="iv.Initialize(\"\")";
__ref._iv /*anywheresoftware.b4j.objects.ImageViewWrapper*/ .Initialize(ba,"");
RDebugUtils.currentLine=24707080;
 //BA.debugLineNum = 24707080;BA.debugLine="mBase.AddView(iv, 0, 0, Width, Height)";
...
RDebugUtils.currentLine=24707081;
 //BA.debugLineNum = 24707081;BA.debugLine="mBase.AddView(pnl, 0, 0, Width, Height)";
...
RDebugUtils.currentLine=24707083;
 //BA.debugLineNum = 24707083;BA.debugLine="bc.Initialize(Width, Height)";
__ref._bc /*b4j.example.bitmapcreator*/ ._initialize(ba,__ref._width /*int*/ ,__ref._height /*int*/ );
RDebugUtils.currentLine=24707084;
 //BA.debugLineNum = 24707084;BA.debugLine="Scale = xui.Scale";
__ref._scale /*float*/  = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getScale();
RDebugUtils.currentLine=24707089;
 //BA.debugLineNum = 24707089;BA.debugLine="OnColor = bc.CreateBrushFromColor(xui.PaintOrColo";
...
RDebugUtils.currentLine=24707090;
 //BA.debugLineNum = 24707090;BA.debugLine="OffColor = bc.CreateBrushFromColor(xui.PaintOrCol";
...
RDebugUtils.currentLine=24707091;
 //BA.debugLineNum = 24707091;BA.debugLine="ThumbColor = bc.CreateBrushFromColor(xui.PaintOrC";
...
RDebugUtils.currentLine=24707092;
 //BA.debugLineNum = 24707092;BA.debugLine="transparent = bc.CreateBrushFromColor(xui.Color_T";
...
RDebugUtils.currentLine=24707093;
 //BA.debugLineNum = 24707093;BA.debugLine="mEnabled = mBase.Enabled";
__ref._menabled /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getEnabled();
RDebugUtils.currentLine=24707094;
 //BA.debugLineNum = 24707094;BA.debugLine="mBase.Enabled = True";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setEnabled(__c.True);
RDebugUtils.currentLine=24707095;
 //BA.debugLineNum = 24707095;BA.debugLine="SetValueImpl(Props.Get(\"Value\"), True)";
...
RDebugUtils.currentLine=24838145;
 //BA.debugLineNum = 24838145;BA.debugLine="mValue = b";
__ref._mvalue /*boolean*/  = _b;
RDebugUtils.currentLine=24838146;
 //BA.debugLineNum = 24838146;BA.debugLine="LoopIndex = LoopIndex + 1";
__ref._loopindex /*int*/  = (int) (__ref._loopindex /*int*/ +1);
RDebugUtils.currentLine=24838147;
 //BA.debugLineNum = 24838147;BA.debugLine="If Immediate Then";
if (true) break;
...
RDebugUtils.currentLine=24838148;
 //BA.debugLineNum = 24838148;BA.debugLine="If mValue Then Draw(1) Else Draw(0)";
if (true) break;
...
RDebugUtils.currentLine=24838150;
 //BA.debugLineNum = 24838150;BA.debugLine="Dim MyIndex As Int = LoopIndex";
_myindex = __ref._loopindex /*int*/ ;
RDebugUtils.currentLine=24838151;
 //BA.debugLineNum = 24838151;BA.debugLine="Dim start As Long = DateTime.Now";
_start = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=24838152;
 //BA.debugLineNum = 24838152;BA.debugLine="Dim duration As Int = 200";
_duration = (int) (200);
RDebugUtils.currentLine=24838153;
 //BA.debugLineNum = 24838153;BA.debugLine="Do While DateTime.Now < start + duration";
if (true) break;
...
RDebugUtils.currentLine=24838154;
 //BA.debugLineNum = 24838154;BA.debugLine="Dim state1 As Float = (DateTime.Now - start) /";
_state1 = (float) ((parent.__c.DateTime.getNow()-_start)/(double)_duration);
RDebugUtils.currentLine=24838155;
 //BA.debugLineNum = 24838155;BA.debugLine="If mValue = False Then state1 = 1 - state1";
if (true) break;
...
RDebugUtils.currentLine=24838156;
 //BA.debugLineNum = 24838156;BA.debugLine="Draw(state1)";
__ref._draw /*String*/ (null,_state1);
RDebugUtils.currentLine=24838157;
 //BA.debugLineNum = 24838157;BA.debugLine="Sleep(16)";
...
RDebugUtils.currentLine=24838158;
 //BA.debugLineNum = 24838158;BA.debugLine="If MyIndex <> LoopIndex Then Exit";
if (true) break;
...
RDebugUtils.currentLine=24838160;
 //BA.debugLineNum = 24838160;BA.debugLine="If MyIndex = LoopIndex Then";
...
RDebugUtils.currentLine=24838161;
 //BA.debugLineNum = 24838161;BA.debugLine="If mValue Then Draw(1) Else Draw(0)";
if (true) break;
...
RDebugUtils.currentLine=25165824;
 //BA.debugLineNum = 25165824;BA.debugLine="Private Sub Draw (State As Float)";
RDebugUtils.currentLine=25165825;
 //BA.debugLineNum = 25165825;BA.debugLine="bc.DrawRect2(bc.TargetRect, transparent, True, 0)";
...
RDebugUtils.currentLine=25165826;
 //BA.debugLineNum = 25165826;BA.debugLine="Dim r As Float = Round(bc.mHeight / 2)";
_r = (float) (__c.Round(__ref._bc /*b4j.example.bitmapcreator*/ ._mheight/(double)2));
RDebugUtils.currentLine=25165827;
 //BA.debugLineNum = 25165827;BA.debugLine="Dim cx As Float = r - 1 * Scale + (bc.mWidth - 2";
...
RDebugUtils.currentLine=25165838;
 //BA.debugLineNum = 25165838;BA.debugLine="smallrect.Initialize(bc.mWidth / 2 - w / 2, cy -";
...
RDebugUtils.currentLine=25165839;
 //BA.debugLineNum = 25165839;BA.debugLine="If State > 0 Then bc.DrawRectRounded2(smallrect,";
if (_state>0) { 
...
RDebugUtils.currentLine=25165840;
 //BA.debugLineNum = 25165840;BA.debugLine="If mEnabled Then";
if (__ref._menabled /*boolean*/ ) { 
RDebugUtils.currentLine=25165841;
 //BA.debugLineNum = 25165841;BA.debugLine="bc.DrawCircle2(cx, cy, r - 2 * Scale, ThumbColor";
...
RDebugUtils.currentLine=25165843;
 //BA.debugLineNum = 25165843;BA.debugLine="bc.SetBitmapToImageView(bc.Bitmap, iv)";
...
RDebugUtils.currentLine=25100288;
 //BA.debugLineNum = 25100288;BA.debugLine="Public Sub getEnabled As Boolean";
RDebugUtils.currentLine=25100289;
 //BA.debugLineNum = 25100289;BA.debugLine="Return mEnabled";
...
RDebugUtils.currentLine=24969216;
 //BA.debugLineNum = 24969216;BA.debugLine="Public Sub getValue As Boolean";
RDebugUtils.currentLine=24969217;
 //BA.debugLineNum = 24969217;BA.debugLine="Return mValue";
...
RDebugUtils.currentLine=24772608;
 //BA.debugLineNum = 24772608;BA.debugLine="Private Sub Pnl_MouseClicked (EventData As MouseEv";
RDebugUtils.currentLine=24772609;
 //BA.debugLineNum = 24772609;BA.debugLine="EventData.Consume";
_eventdata.Consume();
RDebugUtils.currentLine=24772613;
 //BA.debugLineNum = 24772613;BA.debugLine="If mEnabled Then";
if (__ref._menabled /*boolean*/ ) { 
RDebugUtils.currentLine=24772614;
 //BA.debugLineNum = 24772614;BA.debugLine="SetValueImpl(Not(mValue), False)";
__ref._setvalueimpl /*void*/ (null,__c.Not(__ref._mvalue /*boolean*/ ),__c.False);
RDebugUtils.currentLine=24772615;
 //BA.debugLineNum = 24772615;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_ValueC";
...
RDebugUtils.currentLine=25034753;
 //BA.debugLineNum = 25034753;BA.debugLine="mEnabled = b";
__ref._menabled /*boolean*/  = _b;
RDebugUtils.currentLine=25034754;
 //BA.debugLineNum = 25034754;BA.debugLine="SetValueImpl(mValue, True)";
...
RDebugUtils.currentLine=24903680;
 //BA.debugLineNum = 24903680;BA.debugLine="Public Sub setValue(b As Boolean)";
RDebugUtils.currentLine=24903681;
 //BA.debugLineNum = 24903681;BA.debugLine="If b = mValue Then Return";
if (_b==__ref._mvalue /*boolean*/ ) { 
if (true) return "";};
RDebugUtils.currentLine=24903682;
 //BA.debugLineNum = 24903682;BA.debugLine="SetValueImpl(b, False)";
