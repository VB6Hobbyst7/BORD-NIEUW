...
__c.Log(BA.NumberToString(_currenty));
...
__c.Log(("INTERVAL =  "+__c.SmartStringFormatter("",(Object)(_timeoutperiode))+""));
...
__c.Log(("INTERVAL =  "+__c.SmartStringFormatter("",(Object)(_tmr.getInterval()))+""));
