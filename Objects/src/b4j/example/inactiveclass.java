...
public String  _drawpromote_tick() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub drawPromote_Tick()";
 //BA.debugLineNum = 56;BA.debugLine="getBounds";
_getbounds();
 //BA.debugLineNum = 57;BA.debugLine="End Sub";
return "";
}
public String  _enablepromote(boolean _enable) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub enablePromote(enable As Boolean)";
 //BA.debugLineNum = 50;BA.debugLine="tmr_draw_promote.Enabled = enable";
_tmr_draw_promote.setEnabled(_enable);
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return "";
}
public String  _enabletime(boolean _enable) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub enableTime(enable As Boolean)";
 //BA.debugLineNum = 46;BA.debugLine="tmr.Enabled = enable";
_tmr.setEnabled(_enable);
 //BA.debugLineNum = 47;BA.debugLine="End Sub";
return "";
}
public String  _getbounds() throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub getBounds";
 //BA.debugLineNum = 61;BA.debugLine="If (currentX+50) + pnlWidth+30 > frm.Width Then";
if ((_currentx+50)+_pnlwidth+30>_frm.getWidth()) { 
...
_vx = __c.Abs(_vx);
 ...
 //BA.debugLineNum = 67;BA.debugLine="If (currentY+70) + pnlHeight > frm.Height Then";
if ((_currenty+70)+_pnlheight>_frm.getHeight()) { 
...
public String  _initialize(anywheresoftware.b4a.BA _ba,double _promotewidth,double _promoteheight) throws Exception{
innerInitialize(_ba);
 //BA.debugLineNum = 16;BA.debugLine="Public Sub Initialize(promoteWidth As Double, prom";
 //BA.debugLineNum = 17;BA.debugLine="pnlWidth = promoteWidth";
_pnlwidth = _promotewidth;
 //BA.debugLineNum = 18;BA.debugLine="pnlHeight = promoteHeight";
_pnlheight = _promoteheight;
 //BA.debugLineNum = 20;BA.debugLine="timeOutPeriode = (parseConfig.timeOut*(60*1000))";
_timeoutperiode = (int) ((_parseconfig._timeout /*int*/ *(60*1000)));
 //BA.debugLineNum = 21;BA.debugLine="tmr.Initialize(\"timeOut\", timeOutPeriode)";
_tmr.Initialize(ba,"timeOut",(long) (_timeoutperiode));
 //BA.debugLineNum = 22;BA.debugLine="tmr.Enabled = parseConfig.timeOutActive";
_tmr.setEnabled(_parseconfig._timeoutactive /*boolean*/ );
 //BA.debugLineNum = 23;BA.debugLine="tmr_draw_promote.Initialize(\"drawPromote\", 5000)";
_tmr_draw_promote.Initialize(ba,"drawPromote",(long) (5000));
 //BA.debugLineNum = 26;BA.debugLine="End Sub";
return "";
}
public String  _timeout_tick() throws Exception{
 //BA.debugLineNum = 29;BA.debugLine="Sub timeOut_Tick()";
 //BA.debugLineNum = 30;BA.debugLine="timeDiff = DateTime.Now - lastClick";
_timediff = (long) (__c.DateTime.getNow()-_lastclick);
 //BA.debugLineNum = 31;BA.debugLine="If timeDiff > timeOutPeriode Then";
if (_timediff>_timeoutperiode) { 
 //BA.debugLineNum = 32;BA.debugLine="enableTime(False)";
_enabletime(__c.False);
 //BA.debugLineNum = 33;BA.debugLine="CallSubDelayed(scorebord, \"showPromote\")";
__c.CallSubDelayed(ba,(Object)(_scorebord.getObject()),"showPromote");
 //BA.debugLineNum = 35;BA.debugLine="vx = 50";
_vx = 50;
 //BA.debugLineNum = 36;BA.debugLine="vy = 50";
_vy = 50;
 //BA.debugLineNum = 37;BA.debugLine="enablePromote(True)";
_enablepromote(__c.True);
 //BA.debugLineNum = 38;BA.debugLine="CallSub2(scorebord, \"setPromoteRunning\", True)";
